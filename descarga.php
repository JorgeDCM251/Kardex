...
<h2>Descarga (Medicamentos)</h2>
<form method="post" action="/actions/med_descargar.php">
  <div class="form-section">
    <h3>Datos del movimiento</h3>
    <div class="form-grid">
      <div class="form-group"><label class="required">ID Medicamento</label><input name="id_med" required></div>
      ...
      <div class="form-group"><label>Documento</label><input name="documento"></div>
      <div class="form-group"><label>Paciente</label><input name="paciente"></div>
      <div class="form-group"><label>Observación</label><input name="observacion"></div>
    </div>
  </div>
  <div class="button-container"><button class="btn" type="submit">Guardar SALIDA</button></div>
</form>
